...
.controller('Main', ["PACKAGES", "PROCESSORS", function (PACKAGES, PROCESSORS) {
  var vm = this;
...
.filter('format', ["$timeout", "$compile", "$rootScope", function ($timeout, $compile, $rootScope) {
...
.directive('setClassWhenAtTop', ["$window", "$timeout", function ($window, $timeout) {
